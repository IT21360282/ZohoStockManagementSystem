...
<body style="font-family:Arial; background-color:#3385ff;">
	...
	<table class="Table">
		...
		<tr>
			...
			<td class="Td"><form method="post" action="DisplayGoodsServlet"><button class="Button" type="submit" style="margin-left:22px; margin-right:22px;" name="goods" value="<%=order.getOrderID()%>">List Goods</button></form></td>
		</tr>
